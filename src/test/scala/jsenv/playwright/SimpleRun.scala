 ...
 */
class SimpleRun  (run: JSRun, out: SimpleIOReader, err: SimpleIOReader, timeout: FiniteDuration) extends AutoCloseable {
  ...
  private def expectIO(reader: SimpleIOReader, name: String, v: String): this.type = {
